...
export default function Login({ navigation }) {
  ...
  const handleSkipLogin = () => {
    navigation.navigate('Home');  // Skip the login step and go to Home
  };
        ...
        >
          {
            ({ handleChange, handleSubmit, values, errors }) => (
              <View style={{ padding: 20, paddingBottom: 0 }}>
                ...
                <TouchableOpacity style={styles.skipLoginBtn} onPress={handleSkipLogin}>
                  <Text style={{ color: '#fff', fontSize: 18 }}>Proceed Without Login</Text>
                </TouchableOpacity>
              </View>
            )
          }
